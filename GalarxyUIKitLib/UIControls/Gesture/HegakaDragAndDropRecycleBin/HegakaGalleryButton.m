...
@implementation HegakaGalleryButton
...
-(void) touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event {
    ...
    if ([delegate isInsideRecycleBin:self touching:YES]){
        ...
        animation.animationImages = [NSArray arrayWithObjects: 
                                     UIIMAGERESOURCEBUNDLE(@"hegaka_iconEliminateItem1",@"png"),
                                     UIIMAGERESOURCEBUNDLE(@"hegaka_iconEliminateItem2",@"png"),
                                     UIIMAGERESOURCEBUNDLE(@"hegaka_iconEliminateItem3",@"png"),
                                     UIIMAGERESOURCEBUNDLE(@"hegaka_iconEliminateItem4",@"png")
                                     ,nil];
