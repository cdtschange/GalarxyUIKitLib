...
+ (void) showSuccessWithStatus:(NSString *)status forAction:(NSString *)action {
    [ZAActivityBar showImage:UIIMAGERESOURCEBUNDLE(@"ZAActivityBar.bundle/success",@"png")
                      status:status
                   forAction:action];
}
...
+ (void) showErrorWithStatus:(NSString *)status forAction:(NSString *)action {
    [ZAActivityBar showImage:UIIMAGERESOURCEBUNDLE(@"ZAActivityBar.bundle/error",@"png")
                      status:status
                   forAction:action];
}
