...
+ (ZenLayerBackground*) layerWithFrame: (CGRect) frame
{
    ...
    if(instance)
    {
        instance.imgBackground = UIIMAGERESOURCEBUNDLE(@"zenpb_bg",@"png");
...
+ (ZenLayerCircle*) layerWithFrame: (CGRect) frame
{
    ...
    if(instance)
    {
        ...
        instance.needsDisplayOnBoundsChange = YES;
        instance.imgCircle = UIIMAGERESOURCEBUNDLE(@"zenpb_circle",@"png");
...
+ (ZenLayerProgress*) layerWithFrame: (CGRect) frame
{
    ...
    {
        instance.frame = frame;
        instance.imgProgress = UIIMAGERESOURCEBUNDLE(@"zenpb_progress",@"png");
...
+ (ZenLayerPlayButton*) layerWithFrame: (CGRect) frame
{
    ...
    if(instance)
    {
        ...
        instance.originalSize = frame.size;
        instance.needsDisplayOnBoundsChange = YES;
        instance.imgPlayButton = UIIMAGERESOURCEBUNDLE(@"zenpb_playbutton",@"png");
...
+ (ZenLayerPauseButton*) layerWithFrame: (CGRect) frame
{
    ...
    if(instance)
    {
        instance.frame = frame;
        instance.needsDisplayOnBoundsChange = YES;
        instance.imgPauseButton = UIIMAGERESOURCEBUNDLE(@"zenpb_pausebutton",@"png");
    }
    return instance;
}
