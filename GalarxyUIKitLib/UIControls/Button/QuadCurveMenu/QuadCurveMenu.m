...
- (id)initWithFrame:(CGRect)frame menus:(NSArray *)aMenusArray
{
    ...
    if (self) {
        ...
        // add the "Add" Button.
        _addButton = [[QuadCurveMenuItem alloc] initWithImage:UIIMAGERESOURCEBUNDLE(@"bg-addbutton",@"png")
                                       highlightedImage:UIIMAGERESOURCEBUNDLE(@"bg-addbutton-highlighted",@"png")
                                           ContentImage:UIIMAGERESOURCEBUNDLE(@"icon-plus",@"png")
                                highlightedContentImage:UIIMAGERESOURCEBUNDLE(@"icon-plus-highlighted",@"png")];
