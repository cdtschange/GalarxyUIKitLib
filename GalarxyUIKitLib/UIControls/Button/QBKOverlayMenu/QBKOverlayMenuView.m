...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        self.mainBackgroundImage = UIIMAGERESOURCEBUNDLE(@"qbk_mainBackground",@"png");
        self.mainButtonLeftImage = UIIMAGERESOURCEBUNDLE(@"qbk_main-button-left",@"png");
        self.mainButtonUpImage = UIIMAGERESOURCEBUNDLE(@"qbk_main-button-up",@"png");
...
-(void)setMainBackgroundImage:(UIImage *)image{
    _mainBackgroundImage = image;
    _mainBackgroundImageView.image = image;
}
...
- (void)setParentView:(UIView *)view
{
    ...
    _mainBackgroundImageView = [[UIImageView alloc] initWithImage:self.mainBackgroundImage];
...
- (void)unfoldWithAnimationDuration:(float)duration
{
    [UIView animateWithDuration:duration animations:^{
        ...
        [_mainButton setBackgroundImage:self.mainButtonLeftImage forState:UIControlStateNormal];
...
- (void)foldWithAnimationDuration:(float)duration
{
    [UIView animateWithDuration:duration animations:^{
        ...
        [_mainButton setBackgroundImage:self.mainButtonUpImage forState:UIControlStateNormal];
