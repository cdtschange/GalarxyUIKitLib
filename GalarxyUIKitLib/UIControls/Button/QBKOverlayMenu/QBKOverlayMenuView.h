...
@property (nonatomic, retain) UIImage *mainBackgroundImage;
@property (nonatomic, retain) UIImage *mainButtonLeftImage;
@property (nonatomic, retain) UIImage *mainButtonUpImage;
