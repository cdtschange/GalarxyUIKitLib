...
#import "TouchCloudView.h"

@interface TouchCloudView()
...
- (id)initWithFrame:(CGRect)frame andNodeCount:(NSInteger)nodeCount
{
    ...
    if (self) {
        ...
        for (NSInteger i = 0;i < nodeCount; i ++) {
            ...
            TouchCloudButton *cloudButton = [[TouchCloudButton alloc] initWithFrame:CGRectMake(x,
                                                                                     y,
                                                                                     nodeSize.width,
                                                                                     nodeSize.height)];
...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    for (int i=0; i<self.subviews.count; i++) {
        TouchCloudButton *cloud = [self.subviews objectAtIndex:i];
