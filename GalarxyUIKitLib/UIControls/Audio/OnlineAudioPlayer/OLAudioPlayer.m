...
#import "OLAudioPlayer.h"
#import "OLAudioButton.h"
#import "OLAudioStreamer.h"

@implementation OLAudioPlayer
...
{        
    if (!streamer) {
        ...
        self.streamer = [[OLAudioStreamer alloc] initWithURL:self.url];
...
{    
    ...
    button.image = UIIMAGERESOURCEBUNDLE(playImage,@"png");
