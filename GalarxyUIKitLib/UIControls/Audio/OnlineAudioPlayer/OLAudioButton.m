...
#import "OLAudioButton.h"
#import <QuartzCore/QuartzCore.h>
#include <math.h>

static inline double radians (double degrees) {return degrees * M_PI/180;}

NSString *playImage = @"olaudioplayer_play";
NSString *stopImage = @"olaudioplayer_stop";

@implementation OLAudioButton
...
- (id)initWithFrame:(CGRect)frame 
{
    ...
    if (self) 
    {
        ...
        self.image = UIIMAGERESOURCEBUNDLE(playImage,@"png");
    }
...
- (void)startSpin
{
    if (!loadingView) {
        ...
        loadingView.image = UIIMAGERESOURCEBUNDLE(@"olaudioplayer_loading",@"png");
