...
void CMinterruptionListenerCallback (void *inUserData, UInt32 interruptionState)
{
...
- (id) init
{
	...
	{		
		...
		OSStatus status = AudioSessionInitialize(NULL, NULL, CMinterruptionListenerCallback, self);
