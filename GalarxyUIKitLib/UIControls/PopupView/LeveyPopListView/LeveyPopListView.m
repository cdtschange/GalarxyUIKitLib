...
- (id)initWithTitle:(NSString *)aTitle options:(NSArray *)aOptions frame:(CGRect)frame
{
    if (self = [super initWithFrame:frame])
    {
        ...
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(POPLISTVIEW_SCREENINSET, 
                                                                   ...
                                                                   frame.size.width - 2 * POPLISTVIEW_SCREENINSET,
                                                                   frame.size.height - 2 * POPLISTVIEW_SCREENINSET - POPLISTVIEW_HEADER_HEIGHT - RADIUS)];
