...
- (id)init {
    self = [super init];
    if (self) {
        UIImage *backgroundImage = UIIMAGERESOURCEBUNDLE(@"action-sheet-panel",@"png");
...
- (void)addButtonWithTitle:(NSString *)buttonTitle type:(CMActionSheetButtonType)type block:(CallbackBlock)block {
    ...
    NSString *str=[NSString stringWithFormat:@"action-%@-button", color];
    UIImage *image = UIIMAGERESOURCEBUNDLE(str,@"png");
...
- (void)addSeparator {
    UIImage *separatorImage = UIIMAGERESOURCEBUNDLE(@"action-separator",@"png");
