...
- (id)initWithTitle:(NSString *)title parentView:(UIView *)parentView{
    ...
    if (self = [super initWithFrame:CGRectMake(0, parentView.bounds.size.height, parentView.bounds.size.width, 40)]){
...
- (void)drawRect:(CGRect)rect{
    ...
    //Background color
    CGRect rectangle = CGRectMake(0,4,self.frame.size.width,36);
    ...
    CGContextAddLineToPoint(context, self.frame.size.width, 4.5);
    ...
    CGContextAddLineToPoint(context, self.frame.size.width, 3.5);
	...
	CGRect bounds = CGRectMake(0, 0, self.frame.size.width, 3);
	CGFloat alignStroke;
	CGFloat resolution;
