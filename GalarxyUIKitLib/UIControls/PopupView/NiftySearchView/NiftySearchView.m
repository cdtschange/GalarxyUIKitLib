...
- (id)initWithFrame:(CGRect)frame 
{
    ...
    if (self) {
        ...
        [bookmark setImage:UIIMAGERESOURCEBUNDLE(@"niftysearch_UISearchBarBookmarks",@"png") forState:UIControlStateNormal];
        [bookmark setImage:UIIMAGERESOURCEBUNDLE(@"niftysearch_UISearchBarBookmarksPressed",@"png") forState:UIControlStateHighlighted];
        ...
        [bookmarkTarget setImage:UIIMAGERESOURCEBUNDLE(@"niftysearch_UISearchBarBookmarks",@"png") forState:UIControlStateNormal];
        [bookmarkTarget setImage:UIIMAGERESOURCEBUNDLE(@"niftysearch_UISearchBarBookmarksPressed",@"png") forState:UIControlStateHighlighted];
