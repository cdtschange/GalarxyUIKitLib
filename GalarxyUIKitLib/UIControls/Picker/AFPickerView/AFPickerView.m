...
- (id)initWithFrame:(CGRect)frame bgImage:(UIImage *)bgImage shadowImage:(UIImage *)shadowImage glassImage:(UIImage *)glassImage
{
    ...
    if (self) 
    {
        ...
        // backgound
        UIImageView *bacground = [[UIImageView alloc] initWithImage:bgImage];
