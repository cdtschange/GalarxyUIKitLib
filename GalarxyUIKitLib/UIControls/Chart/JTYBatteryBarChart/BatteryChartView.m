...
- (void)drawBG{
    //画背景
    UIImage *bgImg=UIIMAGERESOURCEBUNDLE(@"JTYColumnBase",@"png");
...
-(void)drawColumn:(CGContextRef)context rect:(CGRect)_rect{//画列柱图
    ...
    for(int gNumber = 0;gNumber<[groupData count];gNumber++){//遍历所有的柱状图；
		...
		for(int vNumber = 0; vNumber < [g count]; vNumber++){
            ...
            switch (chartType) {
                case REDChartType:
                {
                    if (gNumber == 0){
                        ...
                        img = UIIMAGERESOURCEBUNDLE(@"JTYColumnRedbody",@"png");
                        aboveImg = UIIMAGERESOURCEBUNDLE(@"JTYColumnRedAbove",@"png");
                        belowImg = UIIMAGERESOURCEBUNDLE(@"JTYColumnRedBelow",@"png");
                ...
                case GRChartType:
                {
                    ...
                    if (gNumber == 0){
                        ...
                        img = UIIMAGERESOURCEBUNDLE(@"JTYColumnWhitebody",@"png");
                        aboveImg = UIIMAGERESOURCEBUNDLE(@"JTYColumnWhiteAbove",@"png");
                        belowImg = UIIMAGERESOURCEBUNDLE(@"JTYColumnWhiteBelow",@"png");
                        
                    }
                    else {
                        
                        img = UIIMAGERESOURCEBUNDLE(@"JTYColumnGreenBody",@"png");
                        aboveImg = UIIMAGERESOURCEBUNDLE(@"JTYColumnGreenAbove",@"png");
                        belowImg = UIIMAGERESOURCEBUNDLE(@"JTYColumnGreenBelow",@"png");
            ...
            [aboveImgView release];
            
            //画阴影
            img=UIIMAGERESOURCEBUNDLE(@"JTYColumnShadow",@"png");
