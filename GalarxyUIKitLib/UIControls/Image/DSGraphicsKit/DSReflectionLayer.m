...
CGImageRef DSCreateGradientImage(NSUInteger pixelsHigh);
...
- (void)drawInContext:(CGContextRef)ctx
{
	...
	CGImageRef gradientMaskImage = DSCreateGradientImage(self.frame.size.height);
...
CGImageRef DSCreateGradientImage(NSUInteger heightInPixels)
{
