...
- (id)initWithAsset:(ALAsset *)theAsset andDelegate:(id<AGIPCGridItemDelegate>)theDelegate
{
    ...
    if (self)
    {
        ...
        if (IS_IPAD())
            self.checkmarkImageView.image = UIIMAGERESOURCEBUNDLE(@"AGIPC-Checkmark-iPad",@"png");
        else
            self.checkmarkImageView.image = UIIMAGERESOURCEBUNDLE(@"AGIPC-Checkmark-iPhone",@"png");
