...
- (void)viewDidLoad {
    ...
    // Toolbar Items
    _previousButton = [[UIBarButtonItem alloc] initWithImage:UIIMAGERESOURCEBUNDLE(@"mwphoto_UIBarButtonItemArrowLeft",@"png") style:UIBarButtonItemStylePlain target:self action:@selector(gotoPreviousPage)];
    _nextButton = [[UIBarButtonItem alloc] initWithImage:UIIMAGERESOURCEBUNDLE(@"mwphoto_UIBarButtonItemArrowRight",@"png") style:UIBarButtonItemStylePlain target:self action:@selector(gotoNextPage)];
...
- (MBProgressHUD *)progressHUD {
    if (!_progressHUD) {
        ...
        self.progressHUD.customView = [[[UIImageView alloc] initWithImage:UIIMAGERESOURCEBUNDLE(@"mwphoto_Checkmark",@"png")] autorelease];
