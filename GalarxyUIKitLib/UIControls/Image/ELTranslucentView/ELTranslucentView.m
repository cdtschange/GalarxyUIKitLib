...
-(void) initLayout
{
    ...
    float boundsViewWidth = boundsImage.size.width * (self.frame.size.width / self.backgroundImage.size.width);
    float boundsViewHeight = boundsImage.size.height * (self.frame.size.height / self.backgroundImage.size.height);
    ...
    // a frame
    _boundsView = [[UIImageView alloc] initWithFrame: CGRectMake(boundsViewX, boundsViewY, boundsViewWidth, boundsViewHeight)];
    ...
    UIImageView *boundsBorderImageView = [[UIImageView alloc] initWithImage: boundsImage];
