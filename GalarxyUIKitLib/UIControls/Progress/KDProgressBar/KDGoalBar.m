...
-(void)setup {
    ...
    bg =  UIIMAGERESOURCEBUNDLE(@"kdprogress_circle_outline",@"png");
    bgPressed = UIIMAGERESOURCEBUNDLE(@"kdprogress_circle_outline_pressed",@"png");
    
    thumb = UIIMAGERESOURCEBUNDLE(@"kdprogress_circle_thumb",@"png");
    ridge = UIIMAGERESOURCEBUNDLE(@"kdprogress_circle_ridge",@"png");
