...
-(void)setMode:(Mode)newMode {
    ...
    if (mode == Week) {
        numBars = 7;
        barBackground = UIIMAGERESOURCEBUNDLE(@"kdprogress_graph_week",@"png");
        margin = weekMargin;
    } else {
        numBars = 12;
        barBackground = UIIMAGERESOURCEBUNDLE(@"kdprogress_graph_year",@"png");
        margin = yearMargin;
    }
...
-(void)setValues:(NSArray *)values {
    ...
    if (mode == Week) {
        ...
        numBars = 12;
        barBackground = UIIMAGERESOURCEBUNDLE(@"graph_year",@"png");
        margin = yearMargin;
