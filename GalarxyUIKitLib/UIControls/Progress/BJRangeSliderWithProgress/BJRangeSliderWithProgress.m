...
- (void)setup {
    ...
    slider = [[UIImageView alloc] initWithImage:[UIIMAGERESOURCEBUNDLE(@"BJRangeSliderEmpty",@"png") stretchableImageWithLeftCapWidth:5 topCapHeight:4]];
    [self addSubview:slider];

    rangeImage = [[UIImageView alloc] initWithImage:[UIIMAGERESOURCEBUNDLE(@"BJRangeSliderBlue",@"png") stretchableImageWithLeftCapWidth:5 topCapHeight:4]];
    [self addSubview:rangeImage];

    progressImage = [[UIImageView alloc] initWithImage:[UIIMAGERESOURCEBUNDLE(@"BJRangeSliderRed",@"png") stretchableImageWithLeftCapWidth:5 topCapHeight:4]];
    ...
    leftThumb.image = UIIMAGERESOURCEBUNDLE(@"BJRangeSliderStartThumb",@"png");
    ...
    rightThumb.image = UIIMAGERESOURCEBUNDLE(@"BJRangeSliderEndThumb",@"png");
...
- (void)setDisplayMode:(BJRangeSliderWithProgressDisplayMode)mode {
    switch (mode) {
        case BJRSWPAudioRecordMode:
            ...
            progressImage.image = [UIIMAGERESOURCEBUNDLE(@"BJRangeSliderRed",@"png") stretchableImageWithLeftCapWidth:5 topCapHeight:4];
            break;
        ...
        case BJRSWPAudioPlayMode:
            ...
            self.showRange = YES;
            self.showProgress = YES;
            progressImage.image = [UIIMAGERESOURCEBUNDLE(@"BJRangeSliderGreen",@"png") stretchableImageWithLeftCapWidth:5 topCapHeight:4];
        default:
            break;
    }
