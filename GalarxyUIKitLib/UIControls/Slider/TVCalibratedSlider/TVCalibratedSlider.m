...
- (void)initializeSlider {
    _markerImage = UIIMAGERESOURCEBUNDLE(@"tvcalslider_marker",@"png");
...
- (void)setStyle:(TVCalibratedSliderStyle)style {
    ...
    if(style == TavicsaStyle) {
        [self setMaximumTrackImage:@"tvcalslider_slider_gray.png" withCapInsets:UIEdgeInsetsMake(0, 16, 0, 16) forState:UIControlStateNormal];
        [self setMinimumTrackImage:@"tvcalslider_slider_blue.png" withCapInsets:UIEdgeInsetsMake(0, 16, 0, 16) forState:UIControlStateNormal];
        [self setThumbImage:@"tvcalslider_slider_normal" forState:UIControlStateNormal withOffsetRelativeToCenterOfTrack:CGPointMake(0, 0)];
        [self setThumbImage:@"tvcalslider_slider_hover" forState:UIControlStateHighlighted withOffsetRelativeToCenterOfTrack:CGPointMake(0, -15)];
    }
}
