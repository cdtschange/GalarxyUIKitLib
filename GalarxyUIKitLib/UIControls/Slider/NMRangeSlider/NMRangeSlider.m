...
- (UIImage *)trackBackgroundImage
{
    ...
    {
        UIImage* image = UIIMAGERESOURCEBUNDLE(@"slider-default-trackBackground",@"png");
...
- (UIImage *)trackImage
{
    if(_trackImage==nil)
    {
        UIImage* image = UIIMAGERESOURCEBUNDLE(@"slider-default-track",@"png");
...
- (UIImage *)lowerHandleImageNormal
{
    ...
    {
        UIImage* image = UIIMAGERESOURCEBUNDLE(@"slider-default-handle",@"png");
...
- (UIImage *)lowerHandleImageHighlighted
{
    ...
    {
        UIImage* image = UIIMAGERESOURCEBUNDLE(@"slider-default-handle-highlighted",@"png");
