...
- (id) initWithFrame:(CGRect)aFrame minValue:(float)minValue maxValue:(float)maxValue barHeight:(float)height withImage:(UIImage *)image withHighlightImage:(UIImage *)highlightImage;
