...
- (void)setStatusBarStyle:(UIStatusBarStyle)statusBarStyle {
    if (UIStatusBarStyleBlackOpaque == statusBarStyle ||
        ...
        [self setBackgroundColor:[UIColor colorWithPatternImage:UIIMAGERESOURCEBUNDLE(@"status-bar-pattern-black",@"jpg")]];
        ...
        [self setBackgroundColor:[UIColor colorWithPatternImage:UIIMAGERESOURCEBUNDLE(@"status-bar-pattern-default",@"jpg")]];
    ...
    [self setProgressBackgroundColor:[UIColor colorWithPatternImage:UIIMAGERESOURCEBUNDLE(@"status-bar-progress",@"png")]];
