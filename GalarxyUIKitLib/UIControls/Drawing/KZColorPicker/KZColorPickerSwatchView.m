...
- (id)initWithFrame:(CGRect)frame 
{
    ...
    self.checkmarkLayer.contents = (id)UIIMAGERESOURCEBUNDLE(@"MNColorViewCheckmark",@"png").CGImage;
...
- (UIColor *)checkerboardColor
{
    ...
    {
        self.checkerboardColor = [UIColor colorWithPatternImage:UIIMAGERESOURCEBUNDLE(@"kzcolor_checkerboard",@"png")];
    }
