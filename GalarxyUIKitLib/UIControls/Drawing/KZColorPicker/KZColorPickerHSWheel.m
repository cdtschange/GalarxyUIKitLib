...
- (id)initAtOrigin:(CGPoint)origin
{
    if ((self = [super initWithFrame:CGRectMake(origin.x, origin.y, 240, 240)])) 
	{
		...
		UIImageView *wheel = [[UIImageView alloc] initWithImage:UIIMAGERESOURCEBUNDLE(@"kzcolor_pickerColorWheel",@"png")];
		...
		UIImageView *wheelKnob = [[UIImageView alloc] initWithImage:UIIMAGERESOURCEBUNDLE(@"kzcolor_colorPickerKnob",@"png")];
