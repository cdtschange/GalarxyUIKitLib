...
- (void)showImageAndReflection:(CALayer*)layer
{
    ...
    blackLayer.backgroundColor = [UIColor clearColor].CGColor;
    ...
    mask.startPoint = CGPointMake(0.5, 0.55);
...
- (UIView *)loadViewAtIndex:(NSInteger)index withContainerView:(UIView *)containerView
{
    ...
    if (autoAddReflection) {
        [self showImageAndReflection:view.layer];
    }
    [self setItemView:view forIndex:index];
    if (containerView)
    {
